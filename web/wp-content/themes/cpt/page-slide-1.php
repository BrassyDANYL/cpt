        ...
        <div class="left__block">
            ...
            <div class="fourth-part">
                <ul>
                    ...
                    <li class="mobbut">
                        <a href="/slide-2" class="next-slide"><span>next step</span> <img class="right-arrow"
                                src="<?php echo get_theme_file_uri();?>/assets/img/icons/right-white-arrow.png"
                                alt="arrow"></a>

                    </li>
                    <li class="mobbut mobbut2">
                        <a><span>previous step</span>
                        </a>
                    </li>
                </ul>
            ...
            <div class="fifth-part">
                ...
                <a class="next-slide" href="/slide-2"><span>next step</span> <img class="right-arrow"
        ...
        <img  class="background" src="<?php echo the_post_thumbnail_url();?>" alt="">
            ...
            <div class="i i1" id="i1">i
                ...
                <div class="pop-up pop-up1">
                    ...
                    <p class="black-first-line"><?php the_field('description_for_pop-up_1');?></p>
