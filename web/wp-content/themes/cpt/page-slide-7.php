        ...
        <div class="left__block">
            ...
            <div class="fourth-part">
                <ul>
                    ...
                    <li class="mobbut">
                        <a href="/slide-8" class="next-slide"><span>next step</span> <img class="right-arrow"
                                src="<?php echo get_theme_file_uri();?>/assets/img/icons/right-white-arrow.png"
                                alt="arrow"></a>
                    </li>
                    <li class="mobbut mobbut2">
                        <a href="/slide-6"><span>previous step</span>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="fifth-part">
                <a href="/slide-6"><img src="<?php echo get_theme_file_uri();?>/assets/img/icons/gray-left-arrow.png"
                        alt="arrow"> <span>previous step</span></a>
                <a class="next-slide" href="/slide-8"><span>next step</span> <img class="right-arrow"
