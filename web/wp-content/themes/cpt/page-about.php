<section class="about" style="background:url('<?php echo get_theme_file_uri() ?>/assets/img/about_header.png') no-repeat; background-position: center; background-size: cover;>
    <?php
    ...
    <div class="about__sections">
        <div class="about__container">
                ...
                <div class="row-about">
                    ...
                    <div class="section__description">
                        ...
                        <div class="description__text">
                            ...
                            <span> <?php the_field('download_paragraph'); ?></span>
                        </div>
            ...
            <div class="about__sections-item download__section acknowledgements__section">
                <div class="row-about">
                    <div class="title__box">
                        <h2 class="section__title acknowledgements__title">Acknowledgements</h2>
                    </div>
                    <div class="section__description ">
