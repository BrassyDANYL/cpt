...
<body>
        ...
        <div class="left__block">
            ...
            <div class="fourth-part">
                <ul>
                    ...
                    <li class="mobbut">
                        <a href="/slide-7" class="next-slide"><span>next step</span> <img class="right-arrow"
                                src="<?php echo get_theme_file_uri();?>/assets/img/icons/right-white-arrow.png"
                                alt="arrow"></a>
                    </li>
                    <li class="mobbut mobbut2">
                        <a href="/slide-5"><span>previous step</span>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="fifth-part">
                <a href="/slide-5"><img src="<?php echo get_theme_file_uri();?>/assets/img/icons/gray-left-arrow.png"
                        alt="arrow"> <span>previous step</span></a>
                <a class="next-slide" href="/slide-7"><span>next step</span> <img class="right-arrow"
   ...
   <div class="all-info al4 panel_lk_recall floatform">
      <button class="close"><img src="<?php echo get_theme_file_uri();?>/assets/img/icons/crestic.png" alt="x"></button>
      <div class="containerforall-info">
          <h3><?php the_field('title_for_pop-up_1');?></h3>
         <span class="orange-line"></span>
