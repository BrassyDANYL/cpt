...
<body>
        ...
        <div class="left__block">
            ...
            <div class="fourth-part">
                <ul>
                    ...
                    <li class="mobbut">
                        <a href="/slide-9" class="next-slide"><span>next step</span> <img class="right-arrow"
                                src="<?php echo get_theme_file_uri();?>/assets/img/icons/right-white-arrow.png"
                                alt="arrow"></a>
                    </li>
                    <li class="mobbut mobbut2">
                        <a href="/slide-7"><span>previous step</span>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="fifth-part">
                <a href="/slide-7"><img src="<?php echo get_theme_file_uri();?>/assets/img/icons/gray-left-arrow.png"
                        alt="arrow"> <span>previous step</span></a>
                <a class="next-slide" href="/slide-9"><span>next step</span> <img class="right-arrow"
   ...
   <div class="all-info al1 panel_lk_recall floatform">
      ...
      <div class="containerforall-info">
         <h3><?php the_field('title_for_pop-up_1');?></h3>
         <span class="orange-line"></span>
         <div class="black-first-line"><?php the_field('description_for_pop-up_1');?></div>
         <div class="moreinfo">
